...
import { ArrowDownLeft, Trash2, Upload, Repeat, Undo2, Info, Plus, Pencil } from 'lucide-react'
...
import { TransactionEditSheet } from '@/components/app/TransactionEditSheet'
                    ...
                    <div className="text-sm font-medium flex items-center gap-1.5">
                      <span className="truncate flex items-center gap-1.5 min-w-0">
                        <button
                          ...
                          className="truncate text-left hover:text-[#0f5257] transition-colors"
                        ...
                        <button
                          onClick={() => setEditingTx(t)}
                          className="p-1 rounded-full text-[#3d4d50] hover:bg-[#ddedf0] transition-all shrink-0"
                          aria-label={`Edit ${t.merchant}`}
                        >
                          <Pencil size={11} />
                        </button>
